...
def plannarPlot (cl):
    ...
    plt.axis([min(Tvec),max(Tvec),-0.1,3.2]) #Xmin Xmax Ymin Ymax
    plt.xlabel('t')
...
def gradientPlot (gradAtt, gradRep):
    ...
    plt.subplot(211)
    for t in t_grad:
        plt.plot([t, t+1], [gradAtt[0][t], gradAtt[0][t+1]],'g')
        plt.plot([t, t+1], [gradRep[0][t], gradRep[0][t+1]],'r')
    ...
    plt.subplot(212)
    for t in t_grad:
        plt.plot([t, t+1], [gradAtt[1][t], gradAtt[1][t+1]],'g')
        plt.plot([t, t+1], [gradRep[1][t], gradRep[1][t+1]],'r')
